...
document.addEventListener("click", (e)=>{
    ...
    if (e.clientX - leftX < spider.clientWidth / 2) spiderX = 0;
    if (e.clientY - topY < spider.clientHeight / 2) spiderY = 0;
    if (e.clientX > rightX - spider.clientWidth / 2) spiderX = wall.clientWidth - spider.clientWidth;
    if (e.clientY > bottomY - spider.clientHeight / 2) spiderY = wall.clientHeight - spider.clientHeight;
